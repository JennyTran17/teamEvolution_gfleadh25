...
public class InteractableWater : MonoBehaviour
{
    ...
    public void ResetEdgeCollider()
    {
        ...
        Vector2 secondPoints = new Vector2(_vertices[_topVerticesIndex[_topVerticesIndex.Length - 1]].x, _vertices[_topVerticesIndex[_topVerticesIndex.Length - 1]].y);
...
public class InteractableWaterEditor : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        corners[3] = center + new Vector3(_water.Width / 2, _water.Height /2, 0); // Top-RIghi
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            _water.transform.position += new Vector3((newTopRight.x - corners[3].x) / 2, (newBottomRight.y - corners[3].y) / 2, 0);
